...
builder.Services.AddScoped<IModuleDashboardProvider, ExecutionWorkspaceDashboardProvider>();
builder.Services.AddScoped<IModuleDashboardProvider, HRWorkspaceDashboardProvider>();
builder.Services.AddScoped<IModuleDashboardProvider, ITWorkspaceDashboardProvider>();
builder.Services.AddScoped<IModuleDashboardProvider, AdministrationDashboardProvider>();
...
builder.Services.AddScoped<IPayrollInputService, PayrollInputService>();
